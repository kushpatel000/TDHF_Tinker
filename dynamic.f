...
c-----Bootstrap section-------------------------
c-----------------------------------------------
c     call tdhfinit to see if TDHF is requested
c     and initialize necessary parameters
c      
      call tdhfinit
c     Copy dt to a variable TDHF will use
      if(usetdhf) then
         tdhfdt = dt
      end if
c-----------------------------------------------
c     call ciinit to see if CI theory/excited
c     calculations are requested and initialize
c     the necessary parameters
c
      call ciinit
c-----------------------------------------------
c     initialize laser
c      call laserinit(nstep)      
c-----------------------------------------------   
