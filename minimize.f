...
c----------------------------------------------------
c     call ciinit to see if CI theory/excited state
c     calculations are requested and initialize the
c     necessary parameters
      call ciinit
c----------------------------------------------------
c     call tdhfinit because CI uses some of its
c     variables
      call tdhfinit
c----------------------------------------------------      
